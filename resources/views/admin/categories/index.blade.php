@extends('admin.layouts.app-layout', ['title' => env('APP_NAME'), 'page' => 'Categories'])
@push('styles')
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6">
                            <h6 class="card-title mb-0 mt-2 lh-lg">Categories List</h6>
                        </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tblCategoriesList" class="table" width="100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Name</th>
...
@push('scripts')
    <script>
        var config = {
                routes: {
                    ajaxIndex: '{{ route('admin.categories.ajaxIndex') }}'
                }
            };
    </script>
    ...
    <script src="{{ asset('cp/assets/js/lms/categories.js?v='.time()) }}"></script>
