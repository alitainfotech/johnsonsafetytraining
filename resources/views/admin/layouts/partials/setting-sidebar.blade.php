<nav class="settings-sidebar">
  <div class="sidebar-body">
    ...
    <div class="theme-wrapper">
      ...
      <a class="theme-item" href="javascript:void(0);">
        <img src="{{ asset('cp/assets/images/screenshots/light.jpg') }}" alt="light theme">
      </a>
      <h6 class="text-muted mb-2">Dark Theme:</h6>
      <a class="theme-item active" href="javascript:void(0);">
        <img src="{{ asset('cp/assets/images/screenshots/dark.jpg') }}" alt="light theme">
      </a>
    </div>
  </div>
</nav>